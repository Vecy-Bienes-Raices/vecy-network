  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Conversation Detail */}
        <div className={`lg:col-span-2 bg-gradient-to-br from-black/20 to-black border border-white/10 rounded-xl p-4 sm:p-6 flex flex-col h-[550px] ${
          !selectedSessionId ? 'hidden lg:flex' : 'flex'
        }`}>
          {selectedData ? (
            <div className="flex flex-col h-full justify-between">
              ...
              <div className="border-b border-white/10 pb-3 mb-3">
                <button
                  ...
                  className="lg:hidden flex items-center gap-1 text-xs text-[#bf953f] font-bold mb-3 hover:underline"
                >
                  ← Volver a lista de chats
                </button>
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-base sm:text-lg font-bold text-white flex items-center gap-2 break-all">
              ...
              <div className="flex-1 overflow-y-auto space-y-4 pr-1 mb-4">
                {loadingMessages ? (
                  ...
                  messages.map((msg, idx) => (
                    ...
                    >
                      <div
                        className={`max-w-[90%] sm:max-w-[85%] px-3.5 py-2.5 rounded-2xl ${
                          msg.role === 'user'
                      ...
                      >
                        ...
                        <p className="text-xs whitespace-pre-wrap leading-relaxed break-words">{msg.content}</p>
              ...
              <div className="bg-zinc-950/40 border border-white/5 rounded-lg p-3 text-xs text-zinc-500 flex justify-between items-center flex-wrap gap-2">
            ...
            <div className="flex flex-col items-center justify-center h-full text-zinc-500 gap-3">
              ...
              <p className="text-xs text-center px-4">Selecciona un chat de la lista izquierda para monitorear la conversación real con JanIA</p>
            </div>
          )}
        </div>
      </div>

...
export async function processConsultingMessage(
  ...
  try {
    ...
    const systemPrompt = 
      ...
      `3. **📐 Especialista en Estudios de Mercado, Valor del M² y Norma SINUPOT (100% Virtuales)**:\n` +
      ...
      `   - **PROACTIVIDAD E INDAGACIÓN DE DATOS FALTANTES**: Solicítale al colega variables clave para su análisis: barrio/sector exacto, estrato, área construida/privada, antigüedad, piso, vista/asoleación, acabados, parqueaderos (independientes o lineales), amenidades y cuota de administración.\n` +
